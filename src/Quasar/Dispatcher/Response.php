    ...
    public function addDecorator($decorator, $options = null)
    {
        if (is_string($decorator)) {
            ...
            if (!$decorator instanceof DecoratorInterface) {
                throw new ResponseException("'$decoratorClass' must implement Quasar\Dispatcher\Response\DecoratorInterface");
            }
            ...
            if ($decorator instanceof DecoratorInterface) {
                ...
                throw new ResponseException("'$decorator' must implement Quasar\Dispatcher\Response\DecoratorInterface");
            }
        } else {
            throw new ResponseException("'$decorator' must be decorator name or Quasar\Dispatcher\Response\DecoratorInterface implementation");
        }
